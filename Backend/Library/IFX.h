...
extern void     TypeAssignPragmas(PINFO);
extern void     NodeAssignPragmas(PNODE);
extern void     EdgeAssignPragmas(PEDGE);

extern void     PragInitPragmas(PRAGS*);
extern void     TypeInitPragmas(PINFO);
extern void     NodeInitPragmas(PNODE);
extern void     EdgeInitPragmas(PEDGE);

extern void     AddName(namelink**,char*);
extern void     BuildHaveList(namelink**);
extern void     DumpList(namelink*);
extern int      InNameList(char*,namelink*);

extern void     AddToNameList(PNODE);
extern void     AddToImportList(PNODE,char*,PINFO);
extern void     PlaceInEntryTable(char*);
extern void     PlaceInFortranTable(char*);
extern void     PlaceInCTable(char*);
...
/* ------------------------------------------------------------ */
/* FUNCTIONS */
extern void     AddPatch(int);
extern void     AddStamp(int,char*);
extern void     AddTimeStamp(void);
extern void     AddToGraphList(PNODE);
extern void     AddToNodeList(PNODE);
extern PADE     AdeAlloc(PNODE,PNODE,int);
extern int      AreConstsEqual(PEDGE,PEDGE);
extern int      AreEdgesEqual(PEDGE,PEDGE);
extern int      AreNodesDependent(PNODE,PNODE);
extern int      AreNodesEqual(PNODE,PNODE);
extern int      FastAreNodesEqual(PNODE,PNODE);
extern int      AreValuesEqual(PEDGE,PEDGE);
extern int      AssignNewKports(PNODE);
extern void     AssignNewLabels(PNODE);
extern int      AssignNewLoopTports(int,PNODE);
extern int      AssignNewLports(int,PNODE);
extern int      AssignNewMports(int,PNODE);
extern void     AssignNewRports(PNODE);
extern int      voidAssignNewRports(void);
extern void     AssignSourceFileName(char*);
extern int      AssignNewTports(int,PNODE);
extern void     AssignTags(PALIST,PNODE);
extern PALIST   AssocListAlloc(int);
extern void     AttachEdge(PNODE,int,PNODE,int,PINFO,char*);
extern void     ChangeEdgeToConst(PEDGE,PEDGE);
extern void     ChangeExportPorts(PNODE,int,int);
extern void     ChangeExportsToConst(PNODE,int,PEDGE);
extern void     ChangeImportPorts(PNODE,int,int);
extern void     ChangeToConst(PEDGE,PEDGE);
extern void     ClearTouchFlags(void);
extern PEDGE    CopyEdge(PEDGE,PNODE,PNODE);
extern void     CopyEdgeAndLink(PEDGE,PNODE,int);
extern void     CopyEdgeAndThreadToUse(PEDGE,PNODE,int);
extern char     *CopyString(char*);
extern void     CreateAndInsertAde(PNODE,PNODE,int);
extern PEDGE    DirectEdge(PNODE,int,PNODE,int,PINFO);
extern int      DontCombineFill(PNODE);
extern PEDGE    EdgeAlloc(PNODE,int,PNODE,int);
extern void     EnterInSet(PSET,PEDGE);
extern void     EnterScope(void);
extern void     Error1(char*);
extern void     Error2(char*,char*);
extern void     ExitScope(void);
extern PNODE    FindEnclosing(PNODE);
extern PEDGE    FindExport(PNODE,int);
extern PNODE    FindFunction(char*);
extern PNODE    FindGraph(int);
extern PNODE    FindGraphNode(PNODE);
extern PEDGE    FindImport(PNODE,int);
extern PINFO    FindInfo(int,int);
extern int      FindLabel(int);
extern int      FindLargestExport(PNODE);
extern int      FindLargestImport(PNODE);
extern int      FindLargestPort(PNODE);
extern int      FindLargestLabel(void);
extern PNODE    FindLastGraph(PNODE);
extern PEDGE    FindLastImport(PNODE);
extern PNODE    FindLastNode(PNODE);
extern PNODE    FindLargestNode(PNODE);
extern PNODE    FindNode(int,int);
extern int      FindReturnsCode(char*);
extern char     *FindReturnsString(int);
extern PEDGE    FindSource(PEDGE);
extern int      FixConstantImports(PNODE,int);
extern int      FixSignedConstantImports(PNODE,int);
extern PCALL    GetNewCallNode(void);
extern char     *GetSourceLine(PNODE);
extern char     *GetStampString(int);
extern int      HasWriteExport(PNODE);
extern void     If1Read(void);
extern void     MonoIf1Read(void);
extern void     If1Write(void);
extern void     MonoIf1Write(void);
extern void     If2Read(void);
extern void     If2Write(void);
extern void     ImportSwap(PNODE);
extern PINFO    InfoAlloc(int,int);
extern char     *IntToAscii(int);
extern int      IntegerPower(int,int);
extern int      IsABRecord(PINFO);
extern int      IsAdePresent(PNODE,PNODE);
extern int      IsAggregate(PINFO);
extern int      IsCInterface(char*);
extern int      IsCalled(char*);
extern int      IsCaller(PNODE,char*);
extern int      IsDivByZero(PNODE);
extern int      IsEntryPoint(char*);
extern int      IsFortranInterface(char*);
extern int      IsInnerLoop(PNODE);
extern int      IsIntrinsic(char*,PINFO);
extern int      IsPMarked(PNODE,int);
extern int      IsPath(PNODE,PNODE);
extern void     IsPathInit(PNODE);
extern int      IsReadOnly(PNODE,int);
extern int      IsReductionInterface(char*);
extern int      IsStamp(int);
extern void     LinkAdeExport(PNODE,PADE);
extern void     LinkAdeImport(PNODE,PADE);
extern PALIST   LinkAssocLists(PALIST,PALIST);
extern void     LinkExport(PNODE,PEDGE);
extern void     LinkExportLists(PNODE,PNODE);
extern void     LinkExportToEnd(PNODE,PEDGE);
extern PNODE    LinkGraph(PNODE,PNODE);
extern void     LinkImport(PNODE,PEDGE);
extern void     LinkImportLists(PNODE,PNODE);
extern PNODE    LinkNode(PNODE,PNODE);
extern void     LinkNodeLists(PNODE,PNODE);
extern PINFO    LookupInfo(int,int);
extern char     *LowerCase(char*,int,int);
extern void     MakeAde(int,int);
extern void     MakeCompound(int,int,int,PALIST);
extern void     MakeConst(int,int,int,char*);
extern void     MakeEdge(int,int,int,int,int);
extern void     MakeGraph(int,int,char*);
extern void     MakeInfo(int,int,int,int);
extern void     MonoMakeCompound(int,char*);
extern void     MonoMakeConst(int,int,int,char*);
extern void     MonoMakeEdge(int,int,int,int,int);
extern void     MonoMakeGraph(int,int,char*);
extern void     MonoMakeNode(int,int);
extern void     MakeNode(int,int);
extern void     MakePtrTypes(void);
extern char     *MyAlloc(int);
extern PBBLOCK  MyBBlockAlloc(void);
extern PNAME    NameAlloc(PNODE,char*,PINFO);
extern PNODE    NodeAlloc(int,int);
extern void     NormalizeNode(PNODE);
extern void     PlaceGraph(PNODE);
extern void     PlaceNode(PNODE);
extern void     PopGraphList(void);
extern void     PopNodeList(void);
extern void     PrepareForNextFile(void);
extern void     PushGraphList(void);
extern void     PushNodeList(void);
extern PALIST   ReadAssocList(int);
extern void     ReadError(char*);
extern int      ReadInteger(void);
extern int      ReadLineId(void);
extern char     *ReadLiteral(int);
extern char     *MonoReadAssocList(void);
extern void     ReadPragmas(void);
extern void     ReadStamp(void);
extern char     *ReadString(int);
extern void     RemoveStamp(int);
extern PSET     SetAlloc(PSET,PNODE);
extern PTEMP    TempAlloc(char*,PINFO,int,int);
extern void     ThreadToUse(PNODE,int,PNODE,int,PINFO);
extern void     TouchTheUnions(PINFO);
extern void     UnlinkAdeExport(PADE);
extern void     UnlinkAdeImport(PADE);
extern void     UnlinkExport(PEDGE);
extern PNODE    UnlinkGraph(PNODE);
extern void     UnlinkImport(PEDGE);
extern PNODE    UnlinkNode(PNODE);
extern char     *UpperCase(char*,int,int);
extern int      UsageCount(PNODE,int);
extern void     Warning1(char*);
extern void     WriteAggregateInfo(void);
extern void     WriteConst(PEDGE);
extern void     WriteGlobals(void);
extern void     WriteImports(PNODE);
extern void     WriteInfo(void);
extern void     MonoWriteConst(char*,PINFO);
extern void     MonoWriteInfo(void);
extern void     MonoWriteNodes(void);
extern void     WriteNodes(PNODE);
extern void     WriteStamps(void);
extern void     AddToEquivClass(PINFO,PINFO);
extern PCALL    CallAlloc(PNODE);
extern int      CanPropagateConst(PEDGE);
extern int      CaseCmp(char*,char*);
extern void     Count(PNODE);
extern void     CreateNewEquivClass(PINFO);
extern void     GatherOthers(PINFO,PINFO);
extern void     InitEquivClasses(void);
extern int      IsCandidate(PNODE);
extern void     PPrintConst(PEDGE);
extern void     PPrintIndentation(int,int);
extern void     PointToHead(void);
extern void     PrintLInfo(int,int,char*,PNODE);
extern void     PrintWarning(char*,int,char*,char*,int);
extern void     PropagateConst(PNODE);
extern void     RemoveFromEquivClass(PINFO,PINFO);
extern int      SameEquivClass(PINFO,PINFO);
extern void     Stop(int);
extern void     WriteLoopMap(char*);
extern void     WriteTheLMap(int,int,PNODE);
extern double   ElapsedTime(struct timeval*,struct timeval*);
extern double   TSECND(void);
extern void     StartProfiler(void);
extern void     StopProfiler(char*);
extern char     *GetNodeName(PNODE);
extern char     *OpCodeNameOf(int);
extern char     *GetMacro(PNODE);
extern char     *GraphName(int);
extern char     *SimpleName(int);
extern char     *CompoundName(int);
extern char     *AtName(int);
extern void     ReadItems(void);
extern void     BuildItems(void);
extern void     CopyEdgeAndReset(PEDGE,PNODE,PNODE);
extern void     CopyExports(PNODE,PNODE);
extern void     CopyImports(PNODE,PNODE,int);
extern PNODE    CopyNode(PNODE);
extern PINFO    NewType(int,int,int,char*);
extern PINFO    GetAggregate(int,PINFO,char*);
extern void     CheckEdge(PEDGE);
extern int      UsingPatch(int);
